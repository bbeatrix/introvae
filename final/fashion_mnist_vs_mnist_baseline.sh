...
do
   name="FIN_basline_gaussian_gamma_sweep_${test_dataset_a}_vs_${test_dataset_b}_${model_architecture}_alpha_reconstructed=${alpha_reconstructed}_alpha_generated=${alpha_generated}_alpha_neg=${alpha_neg}_neg_dataset=${neg_dataset}_m=${m}_beta=${beta}_nc=${normal_class}_seed=${seed}"
