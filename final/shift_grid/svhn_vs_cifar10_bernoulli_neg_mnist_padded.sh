...
reg_lambda=1.0
neg_prior=True
tags='shift_grid,neg_mnist,bernoulli'
d=$(date +%Y-%m-%d-%H:%M:%S)

for neg_prior_mean_coeff in 5 10 15 20 25 30
do
    name_prefix="${d}_FINAL_neg_mnist_bernoulli_1_mean_coeff_${neg_prior_mean_coeff}"
