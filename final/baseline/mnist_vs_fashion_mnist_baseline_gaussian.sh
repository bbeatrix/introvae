...
reg_lambda=1.0
neg_prior=False
tags="baseline,${obs_noise_model},${model_architecture},${test_dataset_a},${test_dataset_b}"
d=$(date +%Y-%m-%d-%H:%M:%S)
neg_prior_mean_coeff=0

for seed in 1 2 3 4 5
do
    name_prefix="${d}_FINAL_baseline_gaussian_1"
