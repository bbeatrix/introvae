...
reg_lambda=1.0
neg_prior=False
tags="neg_mnist,${obs_noise_model},${model_architecture},${test_dataset_a},${test_dataset_b}"
d=$(date +%Y-%m-%d-%H:%M:%S)
...
do
    name_prefix="${d}_FINAL_neg_mnist_gaussian_1_trained_gamma=${trained_gamma}"
