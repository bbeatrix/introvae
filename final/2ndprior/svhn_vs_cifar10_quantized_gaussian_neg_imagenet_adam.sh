...
reg_lambda=1.0
neg_prior=True
tags="junk,adam,neg_imagenet,bn,${obs_noise_model},${model_architecture},${test_dataset_a},${test_dataset_b}"
d=$(date +%Y-%m-%d-%H:%M:%S)
...
do
    name_prefix="${d}_FINAL_neg_imagenet_quantized_gaussian_1_bn"
