...
reg_lambda=1.0
neg_prior=True
tags="sn,adam,adv_gen,bn,${obs_noise_model},${model_architecture},${test_dataset_a},${test_dataset_b}"
d=$(date +%Y-%m-%d-%H:%M:%S)
...
for seed in 0
do
    name_prefix="${d}_FINAL_neg_adv_gen_gaussian_1_bn_sn"
