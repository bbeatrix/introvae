...
frequency=1000
d=$(date +%Y-%m-%d-%H:%M:%S)
name_prefix='FIN_negaux_neweubo_margingrid_trainedgamma'
color=True
...
for eubo_neg_lambda in 100.0 0.0001
do
    for eubo_margin in -1 30 40 60
    do
